...
### Core platform
- Multi-provider support: OpenAI, Anthropic, Google AI, Mistral, DeepSeek, OpenRouter, xAI (Grok), Cohere (500+ models)
...
### SDK
- `llmeter` npm package — wrappers for OpenAI, Anthropic, Google AI, Azure OpenAI, AWS Bedrock, Cohere
