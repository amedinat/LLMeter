...
const MODEL_CATALOG: ModelPricing[] = [
  ...
  },
  {
    ...
    display_name: 'Mistral: Codestral (latest)',
    input_price_per_1m_tokens: 0.3,
    output_price_per_1m_tokens: 0.9,
    capability_tier: 'standard',
    last_verified_at: '2025-07-01T00:00:00.000Z',
  ...
  },
  {
    ...
    display_name: 'Mistral: Pixtral Large (latest)',
    input_price_per_1m_tokens: 2,
    output_price_per_1m_tokens: 6,
    capability_tier: 'premium',
    last_verified_at: '2025-07-01T00:00:00.000Z',
  },
  {
    ...
    display_name: 'Mistral: Pixtral 12B (2409)',
    input_price_per_1m_tokens: 0.15,
    output_price_per_1m_tokens: 0.15,
    capability_tier: 'budget',
    last_verified_at: '2025-07-01T00:00:00.000Z',
  },
  {
    ...
    display_name: 'Mistral: Ministral 3B (2410)',
    input_price_per_1m_tokens: 0.04,
    output_price_per_1m_tokens: 0.04,
    capability_tier: 'budget',
    last_verified_at: '2025-07-01T00:00:00.000Z',
  },
  {
    ...
    display_name: 'Mistral: Ministral 3B (latest)',
    input_price_per_1m_tokens: 0.04,
    output_price_per_1m_tokens: 0.04,
    capability_tier: 'budget',
    last_verified_at: '2025-07-01T00:00:00.000Z',
  },
  {
    ...
    display_name: 'Mistral: Ministral 8B (2410)',
    input_price_per_1m_tokens: 0.1,
  ...
  },
  {
    ...
    display_name: 'Mistral: Ministral 8B (latest)',
    input_price_per_1m_tokens: 0.1,
    output_price_per_1m_tokens: 0.1,
    capability_tier: 'budget',
    last_verified_at: '2025-07-01T00:00:00.000Z',
  },
  {
    ...
    display_name: 'Mistral: Mistral Nemo (open)',
    input_price_per_1m_tokens: 0.15,
    output_price_per_1m_tokens: 0.15,
    capability_tier: 'budget',
    last_verified_at: '2025-07-01T00:00:00.000Z',
  },
  {
    ...
    display_name: 'Mistral: Mistral 7B (open)',
    input_price_per_1m_tokens: 0.25,
  ...
  },
  {
    ...
    display_name: 'Mistral: Mixtral 8x7B (open)',
    input_price_per_1m_tokens: 0.7,
  ...
  },
  {
    ...
    display_name: 'Mistral: Mixtral 8x22B (open)',
    input_price_per_1m_tokens: 2,
    output_price_per_1m_tokens: 6,
    capability_tier: 'standard',
    last_verified_at: '2025-07-01T00:00:00.000Z',
